...
class TrackingMore_Settings
{
    ...
    public function library_scripts()
    {
        ...
        wp_enqueue_script('trackingmore_script_setting', plugins_url(basename(dirname(__FILE__))) . '/assets/js/setting.js');
    }
    ...
    public function page_init()
    {
        ...
        add_settings_field(
            'use_track_button',
            __('Display Track Button at Order History Page', 'trackingmore'),
        ...
        // add_settings_field(
        //     'custom_domain',
        //     __('Display Tracking Information at Custom Domain', 'trackingmore'),
    ...
    {
        printf(
            '<input type="text" id="custom_domain" name="trackingmore_option_name[custom_domain]" value="%s" style="width:100%%">',
            isset($this->options['custom_domain']) ? $this->options['custom_domain'] : 'track.trackingmore.com'
        );
    }
    ...
    public function track_button_callback()
    {
        ...
        printf(
            ...
            (isset($this->options['use_track_button']) && $this->options['use_track_button'] === true) ? 'checked="checked"' : '',__('Use Track Button', 'trackingmore')
        );
    }
}
