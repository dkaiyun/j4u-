<?php
/**
 * Plugin Name: TrackingMore - WooCommerce Tracking
        ...
        final class TrackingMore
        {
            ...
            public function save_meta_box($post_id, $post)
            {
                if (isset($_POST['trackingmore_tracking_number'])) {
                    $tracking_provider = woocommerce_clean($_POST['trackingmore_tracking_provider']);
            ...
            private function display_order_trackingmore($order_id, $for_email)
            {
                ...
                echo $track_message_1 . $values['trackingmore_tracking_provider_name'] . '<br/>' . $track_message_2 . $values['trackingmore_tracking_number'] . $required_fields_msg;
            ...
            private function display_track_button($tracking_provider, $tracking_number, $required_fields_values)
            {
                ...
                $js = '(function(e,t,n){var r,i=e.getElementsByTagName(t)[0];if(e.getElementById(n))return;r=e.createElement(t);r.id=n;r.src="//cdn.trackingmore.com/button/getbutton.js";i.parentNode.insertBefore(r,i)})(document,"script","trackingmore-jssdk")';
                ...
                $track_button = '<div id="as-root"></div><div  token="" class="as-track-button" data-size="normal" data-tracking-number="' . $tracking_number . $temp_url .'" data-express-code = "'. $tracking_provider . '" data-hide-tracking-number="true" data-width="600px" lang="' . $this->locale . '"></div>';
