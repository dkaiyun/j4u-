...
= Version 1.3.3 - Released: Feb 20, 2019 =

* Fix: notices when chat is disabled

= Version 1.3.2 - Released: Feb 07, 2019 =

* Update: plugin framework

= Version 1.3.1 - Released: Dec 05, 2018 =

* New: Support to WordPress 5.0
* Update: plugin framework

= Version 1.3.0 - Released: Oct 22, 2018 =

* Update: plugin framework

= Version 1.2.8 - Released: Aug 7, 2018 =

* Update: plugin framework

= Version 1.2.7 - Released: May 24, 2018 =

* New: Support to WordPress 4.9.6
* New: Privacy Policy Guide
* Update: plugin framework

= Version 1.2.4 - Released: Dec 11, 2017 =

* Update: plugin framework

= Version 1.2.3 - Released: Nov 6, 2017 =

* Update: plugin framework

= Version 1.2.2 - Released: Nov 7, 2016 =

* Fix: added missing files

= Version 1.2.1 - Released: Oct 12, 2016 =

* New: support for CJK characters
* Fix: end conversation issue
* Tweak: Optimized Frontend and Console templates
* Tweak: optimized JS and CSS loading

= Version 1.1.5 - Released: Apr 20, 2016 =

* New: minified version of CSS files

= Version 1.1.4 - Released: Mar 02, 2016 =

* Fix: hidden on the console page, notifications that disturb the positioning

= Version 1.1.3 - Released: Feb 09, 2016 =

* New: show offline message if Firebase loses connection
* Fix: chat page lost during page switch
* Fix: notification counter showing incorrect values
* Fix: minor bugs

= Version 1.1.2 - Released: Oct 30, 2015 =

* Update: changed text domain from ylc to yith-live-chat
* Update: changed all language file for the new text domain

= Version 1.1.1 - Released: Oct 29, 2015 =

* Update: plugin core framework

= Version 1.1.0 - Released: Oct 15, 2015 =

* New: Frontend login username now accepts characters from these Unicode sets: Greek and Coptic, Arabian, Cyrillic, Armenian, Hebrew and Latin-1 (only chars with grave, acute, diaeresis, circumflex, etc.)
* New: minified version of all JS files
* Tweak: Changed global $yith_livechat object to YITH_Live_Chat() singleton.
* Fix: separated JS files for frontend and console
* Fix: code improvements
* Update: language file

= Version 1.0.5 - Released: Aug 15, 2015 =

* New: Support to WooCommerce 2.4
* Update: Plugin core framework

= Version 1.0.4 - Released: July 31, 2015 =

* Fix: session destroy bug

= Version 1.0.3 - Released: July 09, 2015 =

* Fix: session destroy bug

= Version 1.0.2 - Released: May 18, 2015 =

* Fix: code improvements
* Update: language file

= Version 1.0.1 - Released: May 15, 2015 =

* Fix: code improvements
* Update: plugin framework

= Version 1.0.0 - Released: Mar 27, 2015 =
